...
public class Shell extends JFrame{
	...
	private void graficos(){
		...
		tComando.addKeyListener(new KeyListener(){
	...
	private void ejecutar(){
		...
		try
		{
			...
			proc = Runtime.getRuntime().exec(comando+tComando.getText());
			is_in=proc.getInputStream();
			br=new BufferedReader (new InputStreamReader (is_in));
			s_aux = br.readLine();
			tResultado.setText(tResultado.getText()+"bash$ "+tComando.getText()+"\n");
            while (s_aux!=null)
            {
